...
<![if !supportTabStrip]>
<link id="shLink" href="Klinik.fld/sheet001.htm">
<link id="shLink" href="Klinik.fld/sheet002.htm">
<link id="shLink">
...
<![endif]><!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Lokasi</x:Name>
    <x:WorksheetSource HRef="Klinik.fld/sheet001.htm"/>
   </x:ExcelWorksheet>
   <x:ExcelWorksheet>
    <x:Name>Oprasional</x:Name>
    <x:WorksheetSource HRef="Klinik.fld/sheet002.htm"/>
   </x:ExcelWorksheet>
  </x:ExcelWorksheets>
  <x:Stylesheet HRef="Klinik.fld/stylesheet.css"/>
  <x:WindowHeight>14820</x:WindowHeight>
  <x:WindowWidth>27320</x:WindowWidth>
...
<frameset rows="*,39" border=0 width=0 frameborder=no framespacing=0>
 <frame src="Klinik.fld/sheet001.htm" name="frSheet">
 <frame src="Klinik.fld/tabstrip.htm" name="frTabs" marginwidth=0 marginheight=0>
 <noframes>
  <body>

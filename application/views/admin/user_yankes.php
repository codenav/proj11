  ...
  <div class="title">
    <span><?php echo $title; ?></span>
      <div class="col s12 bred">
        ...
        <a href="#!" class="breadcrumb">Data Yankes</a>
      </div>
  </div>
  <nav class="teal">
      ...
      <tbody>
        ...
        <div id="modal<?php echo $news_item->id_admin ?>" class="delete modal">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo site_url('admin/delete_yankes/'.$news_item->id_admin); ?>" class=" modal-action waves-effect waves-green btn-flat">Iya</a>
          </div>
        </div>

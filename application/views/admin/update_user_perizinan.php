...
echo form_open('admin/update_user_perizinan/'.$news_item['id_admin'],$attributes);
?>
<main>
  <div class="title">
    <span><?php echo $title; ?></span>
      <div class="col s12 bred">
        ...
        <a href="#!" class="breadcrumb">Update User Perizinan</a>
      </div>
  </div>
  <div class="content">
    <div class="row form">
      <div class="col s12">
        <div class="card-panel cus-tambah white lighten-2">
          <p class="sub-tit teal lighten-2">Update User Perizinan</p>
          <div class="content">
            <div class="row">

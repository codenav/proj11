...
<main>
  <div class="title">
    <span><?php echo $title; ?></span>
      <div class="col s12 bred">
        ...
        <a href="#!" class="breadcrumb">Data Kadinkes</a>
      </div>
  </div>
  <nav class="teal">
  ...
  <div class="content ">
    <div class="card-panel white lighten-2">
        <a href="<?php echo site_url('admin/tambah_user_kadinkes'); ?>" class="waves-effect waves-light btn">Tambah</a>
    <table class="highlight striped" id="example">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class="waves-effect waves-light btn blue lighten-1 pad" href="<?php echo site_url('admin/update_user_kadinkes/'.$news_item->id_admin); ?>">
        ...
        <div id="modal<?php echo $news_item->id_admin ?>" class="delete modal">
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo site_url('admin/delete_kadinkes/'.$news_item->id_admin); ?>" class=" modal-action waves-effect waves-green btn-flat">Iya</a>
          </div>
        </div>

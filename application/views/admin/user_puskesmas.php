...
<main>
  <div class="title">
    <span><?php echo $title; ?></span>
      <div class="col s12 bred">
        ...
        <a href="#!" class="breadcrumb">Data Puskesmas</a>
      </div>
  </div>
  <nav class="teal">
  ...
  <div class="content ">
    ...
    <div class="card-panel white lighten-2">
        <a href="<?php echo site_url('admin/tambah_user_puskesmas'); ?>" class="waves-effect waves-light btn">Tambah</a>
    <table class="highlight striped" id="example">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class="waves-effect waves-light btn blue lighten-1 pad" href="<?php echo site_url('admin/update_user_puskesmas/'.$news_item->id_admin); ?>">

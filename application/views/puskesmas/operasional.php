  ...
  <div class="row">
    <div class="col s12 m8">
      <div class="card-panel white">
        <span class="black-text"><p><h3>Standart Operasional</h3></p>
        <div class="card-panel white">
            <p>Standart Operasional</p>
        ...
        <div class="card-panel white">
           <p>Kesesuaian Izin Operasinonal</p>
              ...
              <div class="col s12">
                <div class="card-panel cus-tambah white lighten-2">
                  <div class="input-field col m6">
                      <a href="<?php echo site_url('puskesmas/puskesmas_bangunan'); ?>" class="waves-effect waves-light btn">Kembali</a>
                      <a href="<?php echo site_url('puskesmas/puskesmas_kesesuaian'); ?>" class="waves-effect waves-light btn">Lanjutkan</a>
                  </div>
                </div>
              </div>
            </div>

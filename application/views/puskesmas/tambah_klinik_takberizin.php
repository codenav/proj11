  ...
  <div class="title">
    <span><?php echo $title; ?></span>
      <div class="col s12 bred">
        <a href="#!" class="breadcrumb">asgasd</a>
        <a href="#!" class="breadcrumb">Tambah User Klinik</a>
      </div>
  </div>
  <div class="content">
    <div class="row form">
      <div class="col s12">
        <div class="card-panel cus-tambah white lighten-2">
          <p class="sub-tit teal lighten-2">Tambah Klinik Takberizin</p>
          <div class="content">
            <div class="row">
              ...
              <div class="input-field col s12">
                <select name="kelurahan">
                  ...
                  <option value="Kebonjeruk">Kebon Jeruk</option>
                </select>

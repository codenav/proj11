...
class Penelitian extends CI_Controller {
	...
	public function send_mail($id){
		...
		$stat_email = $this->penelitian_model->get_status_for_email($id);

		foreach ($stat_email as $stat) {
			$nama = $stat['nama'];
			$institusi = $stat['institusi'];
			$jenis_surat = $stat['jenis_surat'];
			$waktu_mulai = tgl_indo($stat['waktu_mulai']);
			$waktu_selesai = tgl_indo($stat['waktu_selesai']);
			$bagian = $stat['bagian'];
		}

		if ($jenis_surat == 'pkl' || $jenis_surat == 'pkl_medis'){
	  ...
	  $this->email->message("Dengan ini memberitahukan bahwa :
													 <br>Nama : ".$nama."
													 <br>Institusi : ".$institusi."
													 <br>Maksud : ".$maksud."
													 <br>Waktu : ".$waktu_mulai." - ".$waktu_selesai."
													 <br>Ditempatkan di bagian : ".$bagian.".
													 <br><br>Surat keterangan telah selesai dibuat, silahkan ambil dibagian Umum.
													 <br>Terima Kasih.");
